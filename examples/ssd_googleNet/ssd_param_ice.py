...
##################################################################
train_data = '{}/data/VOC0712/VOCdevkit/VOC0712/lmdb/VOC0712_trainval_lmdb'.format(caffe_root)
test_data = '{}/data/VOC0712/VOCdevkit/VOC0712/lmdb/VOC0712_test_lmdb'.format(caffe_root)
...
job_name = "SSD_{}x{}_{}".format(resize_width, resize_height, timestr)
