...
label_map_file = '{}/data/coco/labelmap_coco.prototxt'.format(caffe_root)
output_result_dir = "{}/result/ssd_googlenet_bn".format(caffe_root)
timestr = strftime("%Y-%m-%d", gmtime())
job_name = "SSD_coco_{}x{}_{}_{}".format(resize_width, resize_height, timestr, job_id)
...
name_size_file = "{}/data/coco/minival2014_name_size.txt".format(caffe_root)
